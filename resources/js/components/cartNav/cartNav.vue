                ...
                <div>
                    ...
                    <div class="row line_bottom pb-4 pt-4" v-for="product in cart" v-if="product.id!=null">
                     ...
                     <div class="col-11 row">
                        ...
                        <p class="header_title col-1 text-right"></p>
                        <p class="header_title col-2 text-center">CHF {{tva}}<span v-if="finalPrice % 1 === 0">.–</span><span v-if="(((finalPrice*1000) % 1 === 0) && (finalPrice % 1 !== 0))">0</span></p>
                               <p class="header_title col-6">Livraison</p>
                        <p class="header_title col-1 text-right"></p>
                        <p class="header_title col-2 text-center">CHF {{livraison}}<span v-if="finalPrice % 1 === 0">.–</span><span v-if="(((finalPrice*1000) % 1 === 0) && (finalPrice % 1 !== 0))">0</span></p>
                               <p class="header_title col-6">Total</p>
                        <p class="header_title col-1 text-right"></p>
                        <p class="header_title col-2 text-center">CHF {{finalPrice}}<span v-if="finalPrice % 1 === 0">.–</span><span v-if="(((finalPrice*1000) % 1 === 0) && (finalPrice % 1 !== 0))">0</span></p>
                    </div>
                   </div>
               </div>
           </li>
