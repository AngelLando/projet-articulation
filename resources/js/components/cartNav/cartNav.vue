<template>
    <div>
        <li class="nav-item" @mouseover="getCart()" @mouseleave="hover = false">
            ...
            <a class="nav-link panier" :href="url">PANIER</a>
            <div class="cart" v-if="hover == true">
                <div v-if="emptyCart">
                    ...
                    <div class="cart_header_2 row">
                     <p class="header_title col-6">Livraison</p>
                     <p class="header_title col-4 text-center">CHF {{livraison}}<span v-if="finalPrice % 1 === 0">.–</span><span v-if="(((finalPrice*1000) % 1 === 0) && (finalPrice % 1 !== 0))">0</span></p>
                 </div>
                 <div class="cart_header row">
                     <p class="header_title col-6">Total</p>
                     <p class="header_title col-4 text-center">CHF {{finalPrice}}<span v-if="finalPrice % 1 === 0">.–</span><span v-if="(((finalPrice*1000) % 1 === 0) && (finalPrice % 1 !== 0))">0</span></p>
                 </div>
                       <div class="row cart_buttons text-center justify-content-center pb-2">
                   <div class=" col-5 continuer_achats text-center d-flex flex-column align-items-center justify-content-center"><a class="continuer_text" href="cart">Panier</a></div>
                   <div class="col-1"></div>
                                      <div class=" col-5 continuer_achats text-center d-flex flex-column align-items-center justify-content-center"><a class="continuer_text" href="checkout">Commander</a></div>
