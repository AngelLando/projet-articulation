                ...
                <div class="products">
                    <div class="container">
                        <div class="row products_row">
                            ...
                            <!-- Product -->
                            <div v-for="(product,index,i) in products"  class="counter col-xl-4 col-md-6" v-if="(((selected_years.length == 0) || transform(selected_years, product) == 1) && ((selected_appellations.length == 0) || isInArray(selected_appellations, product.appellation) == 1) && ((selected_tags.length == 0) || isInArray(selected_tags, product.tag) == 1) && (product.price > value_2[0] && product.price < value_2[1]) && (selected_kinds.length == 0 || selected_kinds.includes(product.kind)) && (selected_formats.length == 0 || selected_formats.includes(product.format)) && (selected_packagings.length == 0 || selected_packagings.includes(product.packaging_capacity)) && (selected_countries.length == 0 || selected_countries.includes(product.country)))">
                                <div class="product">
                                    <div>
