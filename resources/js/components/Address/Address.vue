            ...
            <div class="super_container_inner">
                ...
                <div class="products mb-5">
                    ...
                    <div class="container pb-3 pt-3">
                        <div v-if="!emptyCart" class="mt-5 empty text-center">Vous n'avez pas de produit dans votre
                            panier actuellement.
                        </div>
                        <div class="pt-3 pb-1 checkout row" v-if="emptyCart">
                            <form @submit.prevent="submitAddress(isHiddenBillTo,isHiddenShipTo)" action="#"
                                  class=" row billing-form">
                                <div class="row align-items-end col-md-9">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="select-wrap">
                                                ...
                                                <select name="gender1" id="gender1" v-model="gender1"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="select-wrap">
                                                ...
                                                <p class="error pt-2" v-if="errors['address1.country1']">
                                                    {{errors['address1.country1'][0]}}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt-2 line_top pt-3">
                                            <div class="item_filter_btn chiller_cb">
                                                <input id="shipto" type="checkbox" name="optradio"
                                                       v-on:click="isHiddenShipTo =!isHiddenShipTo"><label for="shipto">Livrer
                                                à une autre adresse</label>
                                                <span></span>
                                            </div>
                                            <div class="row" v-if="isHiddenShipTo">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="select-wrap">
                                                            ...
                                                            <select name="gender2" id="gender2" v-model="gender2"
                                                                    class="form-control">
                                                                <option value="m">Mr</option>
                                                                <option value="f">Mme</option>
                                                                <option value="other">/</option>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="firstname2" name="firstname2"
                                                               v-model="firstname2" class="form-control" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" id="lastname2"
                                                               name="lastname2" v-model="lastname2">
                                                    </div>
                                                </div>
                                                <div class="w-100"></div>
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="street2"
                                                               name="street2" v-model="street2">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="npa2">NPA</label>
                                                        <input type="number" id="npa2" name="npa2" v-model="npa2"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="city1">Localité</label>
                                                        <input type="text" id="city2" name="city2" v-model="city2"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                                <div class="w-100"></div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="region2" class="form-control"
                                                               name="region2" v-model="region2">
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="select-wrap">
                                                            ...
                                                            <select name="country2" id="country2" v-model="country2"
                                                                    class="form-control">
                                                                <option value="CH">Suisse</option>
                                                                <option value="FR">France</option>
                                                            </select>
                                            ...
                                            <div class="item_filter_btn chiller_cb">
                                                <input id="billto" type="checkbox" name="optradio"
                                                       v-on:click="isHiddenBillTo =!isHiddenBillTo"><label for="billto">Facturer
                                                à une autre adresse</label>
                                                <span></span>
                                            </div>
                                            <div class="row" v-if="isHiddenBillTo">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="select-wrap">
                                                            ...
                                                            <select name="gender3" id="gender3" v-model="gender3"
                                                                    class="form-control">
                                                                <option value="m">Mr</option>
                                                                <option value="f">Mme</option>
                                                                <option value="other">/</option>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="firstname3" name="firstname3"
                                                               v-model="firstname3" class="form-control" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <label for="lastname3">Nom de famille</label>
                                                        <input class="form-control" type="text" id="lastname3"
                                                               name="lastname3" v-model="lastname3">
                                                    </div>
                                                </div>
                                                <div class="w-100"></div>
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="street3"
                                                               name="street3" v-model="street3">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="npa3">NPA</label>
                                                        <input type="number" id="npa3" name="npa3" v-model="npa3"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="city3" name="city3" v-model="city3"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                                <div class="w-100"></div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="region3" class="form-control"
                                                               name="region3" v-model="region3">
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="select-wrap">
                                                            ...
                                                            <select name="country3" id="country3" v-model="country3"
                                                                    class="form-control">
                                                                <option value="CH">Suisse</option>
                                                                <option value="FR">France</option>
                                                            </select>
                                    ...
                                    <div class="col-md-12 line_bottom mb-2 pt-1 pb-4">
                                        ...
                                        <textarea id="comment" class="col-md-12" name="comment"
                                                  placeholder="Ajouter un commentaire..." v-model="comment">
        </textarea>
                                    </div>
                                    <div class="col-md-12 line_bottom mb-4 pt-1 pb-2" >
                                        ...
                                        <div class="item_filter_btn chiller_cb" v-if="id==null">
                                            <input id="mailto" type="checkbox" name="optradio"
                                                   v-on:click="isHiddenMail =!isHiddenMail"><label for="mailto">Recevoir
                                            la facture par mail</label>
                                            <span></span>
                                        </div>

                                        <div v-if="isHiddenMail">
                                            <input placeholder="votre e-mail..." type="email" name="mail" id="mail"
                                                   class="form-control mt-1" v-model="email">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3 order order-md-2 ml-2 mb-4">
                                    ...
                                    <ul class="list-group mb-3">
                                        ...
                                        <li v-if="isHiddenPromoCode"
                                            ...
                                            <span class="text-success">- CHF {{rabais}}<span class="text-success"
                                                                                             v-if="rabais % 1 === 0">.–</span><span
                                                    class="text-success"
                                                    v-if="(((rabais*1000) % 1 === 0) && (rabais % 1 !== 0))">0</span></span>
                                        </li>

                                        <li class="list-group-item d-flex justify-content-between background_grey">
                                            <h6 class="my-0">Total</h6>
                                            <p class="price_total" v-model="finalPrice">CHF {{finalPrice}}<span
                                                    class="price_total" v-if="finalPrice % 1 === 0">.–</span><span
                                                    class="price_total"
                                                    v-if="(((finalPrice*1000) % 1 === 0) && (finalPrice % 1 !== 0))">0</span>
                                            </p>
                                        </li>
                                    </ul>
                                    ...
                                    <form @submit.prevent="checkPromoCode()" class="card p-2">
                                        <div class="input-group">
                                            <input type="text" v-model="promocode" class="form-control" id="promocode"
                                                   >
                                    ...
                                    <div class="card p-2 mt-3 pl-4 pt-3 ">
                                        ...
                                        <div class="d-block my-3">
                                            <div class="custom-control custom-radio">
                                                <input id="credit" name="paymentMethod" v-model="payment_method"
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input id="paypal" name="paymentMethod" v-model="payment_method"
