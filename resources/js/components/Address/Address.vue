                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt-2">
                                            <div class="radio">
                                                <label><input id="shipto" type="checkbox" name="optradio"
                                                              v-on:click="isHiddenShipTo =!isHiddenShipTo">Livrer à une
                                                    autre adresse</label>
                                            ...
                                            <div>
                                                <label><input id="billto" type="checkbox" name="optradio"
                                                              v-on:click="isHiddenBillTo =!isHiddenBillTo">Facturer à
                                                    une autre adresse</label>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-9"></div>
                                            <button type="submit" class="submit_order">Payer la commande</button>
                                        </div>
                                    </div>
                                </div>
                            </form><!-- END -->
